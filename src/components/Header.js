      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div className="flex items-center gap-x-12 lg:flex-1">
          <Link to="/" className="-m-1.5 p-1.5">
            ...
            <img className="h-16 w-auto" src={logo} alt="Betting For Value logo" />
          </Link>
        </div>
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-6">
                ...
                <Link to="/community" className="block rounded-lg py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">
                  Community
                </Link>
              </div>
            </div>
