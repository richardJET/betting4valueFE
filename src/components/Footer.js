    ...
    <footer className="bg-white py-12">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <p className="text-xs leading-5 text-gray-500">
          {" "}
          At Betting for Value, we believe in responsible gambling. We
          understand that sports betting can be addictive, and it's important to
          set limits and know when to take a break. We encourage our readers to
          gamble within their means and never to chase their losses.{" "}
        </p>
        <button
          type="button"
        ...
        >
          <a
            href="https://www.responsiblegambling.org/for-the-public/problem-gambling-help/help-for-canadians/"
            target="_blank"
            rel="noreferrer"
          >
            If You Need Help
