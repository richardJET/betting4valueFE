  ...
  return (
    <>
      <div className="bg-light-green">
        <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 flex gap-2">
          <div className="lg:my-20 my-12">
            <h2 className="text-7xl font-bold mb-8">
              Discover value together!
            </h2>
            <p className="font-semibold text-lg mb-5">
              The Betting For Value community is more than just picking winners.
              Success is defined by positive expected value and closing line
              value.
            </p>
            <p className="font-semibold text-lg my-2">
              Our vision is to cultivate a community where every bettor is a
              value seeker, using data to uncover hidden opportunities and drive
              consistent profitability.
            </p>
            <a
              href="https://discord.gg/MfPtKRVbPC"
              target="_blank"
              rel="noreferrer"
              className="bg-blurple py-3 px-4 my-5 inline-flex justify-center items-center rounded-md font-bold border text-sm leading-6 text-white hover:bg-light-blurple transition-all focus:outline-none focus:ring-2s focus:ring-blurple focus:ring-offset-2"
            >
              Join the Discord{" "}
              <img
          ...
          <div className="w-1/3 hidden lg:inline-block my-8">
            <img
              src="https://images.unsplash.com/photo-1579389083395-4507e98b5e67?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format"
              alt="2 individuals on their laptops"
      ...
      <div className="max-w-7xl mx-auto mt-5 p-4 sm:p-6 lg:p-8 text-center">
        ...
        <p className="font-semibold text-lg mb-5">
          Gain advice and guidance from our profitable betting experts for
          absolutely free!
        </p>
