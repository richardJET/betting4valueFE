            ...
            <div className="bg-light-green">
                <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 flex gap-2">
                    ...
                    <div className="w-1/3 hidden lg:inline-block my-8">
                        <img src="https://images.unsplash.com/photo-1579389083395-4507e98b5e67?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format" alt="2 individuals on their laptops" className=" rounded-md object-cover h-full" />
                    </div>
                </div>
